...
describe("findAll", function () {
  test("works: returns all", async function () {
  ...
  test("works: with min employees", async function () {
  ...
  test("works: with max employees", async function () {
  ...
  test("works: no query", async function () {
    let companies = await Company.findAll({ name: "no name" });
    expect(companies).toEqual([]);
  });
